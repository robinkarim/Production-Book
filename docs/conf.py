...
version = cirrent.__version__
# The full version, including alpha/beta/rc tagss
release = cirrent.__version__
...
latex_documents = [
  (master_doc, 'CirrentDocs.tex', u'Cirrent Documentation',
   u'Rob', 'manual'),
]
...
man_pages = [
    (master_doc, 'cirrent', u'Cirrent Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Cirrent', u'Cirrent Documentation',
   author, 'Cirrent', 'One line description of project.',
   'Miscellaneous'),
]
